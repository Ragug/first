...
async def start(client,message):
  await message.reply_text(f"Hello {message .from_user.first_name}\nhello i am a bot short link genrator\n made by RAGU G find me on instagram I'd is ragug19 or click this link https://www.instagram.com/ragug19?r=nametag ", reply_to_message_id = message.message_id)
